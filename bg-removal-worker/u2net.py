...
==========================================================================
Minimal PyTorch implementation of U²-Net for DFC background removal service.
Architecture: RSU-7/6/5/4/4F encoder-decoder with multi-scale side outputs.

Weights: Download u2net.pth from https://github.com/xuebinqin/U-2-Net
"""
...
class RSU4F(nn.Module):
    """RSU-4F: dilated variant without pooling (for smallest feature maps)."""
...
class U2NET(nn.Module):
    """U²-Net: nested U-architecture for salient object detection."""
