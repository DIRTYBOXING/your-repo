...
/// Role & Permission Editor — DFC Admin
/// Create custom roles, assign granular permissions.
class RolePermissionEditorPage extends StatelessWidget {
  const RolePermissionEditorPage({super.key});

  @override
  Widget build(BuildContext context) {
    // Sample roles (replace with backend integration)
    final roles = [
      _Role('Owner', ['All']),
