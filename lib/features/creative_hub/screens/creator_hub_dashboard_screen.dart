          ...
          const _ToolGrid(
            tools: [
              _HubTool(
                ...
                routeName: RouteConstants.viralPostTemplate,
              ),
              _HubTool(
                'Thread Composer',
                Icons.view_stream,
                ...
                routeName: RouteConstants.twitterThreadComposer,
              ),
              _HubTool(
                'Script Writer',
                ...
                routeName: RouteConstants.youtubeScriptWriter,
              ),
              _HubTool(
                'Post Preview',
                Icons.facebook,
                ...
                routeName: RouteConstants.facebookPostPreview,
              ),
            ],
          ),
          const SizedBox(height: 20),
          ...
          const _ToolGrid(
            tools: [
              _HubTool(
                ...
                routeName: RouteConstants.aiQuickEdit,
              ),
              _HubTool(
                'Brand Voices',
                ...
                routeName: RouteConstants.brandVoiceManager,
              ),
              _HubTool(
                'Promo Video',
                Icons.videocam,
                ...
                routeName: RouteConstants.promoVideoEditor,
              ),
              _HubTool(
                'Creative Studio',
                Icons.palette,
                ...
                routeName: RouteConstants.creativeHub,
              ),
            ],
          ),
          const SizedBox(height: 20),
          ...
          const _ToolGrid(
            tools: [
              _HubTool(
                ...
                routeName: RouteConstants.socialQueue,
              ),
              _HubTool(
                'Content Calendar',
                ...
                DesignTokens.neonCyan,
                'Visual week planner',
                routeName: RouteConstants.socialCommandCenter,
              ),
              _HubTool(
                'Content Pipeline',
                Icons.moving,
                ...
                routeName: RouteConstants.contentPipelineDashboard,
              ),
              _HubTool(
                'Link in Bio',
                Icons.link,
                ...
                routeName: RouteConstants.linkInBio,
              ),
            ],
          ),
          const SizedBox(height: 20),
          ...
          const _ToolGrid(
            tools: [
              _HubTool(
                ...
                routeName: RouteConstants.localBusinessMarketing,
              ),
              ...
              _HubTool(
                ...
                routeName: RouteConstants.utmLinkBuilder,
              ),
              _HubTool(
                'QR Promos',
                Icons.qr_code,
                ...
                routeName: RouteConstants.qrPromo,
              ),
            ],
          ),
          const SizedBox(height: 20),
          ...
          const _ToolGrid(
            tools: [
              _HubTool(
                ...
                routeName: RouteConstants.marketingHQ,
              ),
              _HubTool(
                'Engagement',
                Icons.insights,
                ...
                routeName: RouteConstants.engagementDashboard,
              ),
              _HubTool(
                'Growth Engine',
                Icons.trending_up,
                ...
                routeName: RouteConstants.growthEngineDashboard,
              ),
              _HubTool(
                'Cost Estimator',
                Icons.calculate,
                ...
                routeName: RouteConstants.marketingCostEstimator,
              ),
            ],
          ),
