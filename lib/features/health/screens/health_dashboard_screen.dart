          ...
          Row(
            children: [
              _quickNavBtn(
                ...
                label: 'Fight Camp',
                color: DesignTokens.neonAmber,
                route: rc.RouteConstants.fightCampToolsPath,
              ),
              const SizedBox(width: 8),
              _quickNavBtn(
