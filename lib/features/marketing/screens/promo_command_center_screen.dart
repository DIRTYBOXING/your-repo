  ...
  Widget _buildCategoryGrid() {
    final categories = [
      _Category(
        ...
        color: AppTheme.neonCyan,
        route: RouteConstants.contentPipelineDashboardPath,
      ),
      _Category(
        icon: Icons.share,
        title: 'Social Media',
        ...
        color: AppTheme.neonMagenta,
        route: RouteConstants.socialQueuePath,
      ),
      _Category(
        icon: Icons.event,
        title: 'Events & Promos',
        ...
        color: AppTheme.neonOrange,
        route: RouteConstants.eventsPath,
      ),
      _Category(
        ...
        color: AppTheme.neonPurple,
        route: RouteConstants.marketingAnalyticsPath,
      ),
      _Category(
        icon: Icons.campaign,
        title: 'Campaigns',
        ...
        route: RouteConstants.marketingHQPath,
      ),
      _Category(
        icon: Icons.qr_code,
        title: 'QR & Links',
        ...
        route: RouteConstants.qrPromoPath,
      ),
      _Category(
        ...
        route: RouteConstants.contentCalendarPath,
      ),
    ];
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: cat.color.withValues(alpha: 0.1), blurRadius: 12),
          ],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildQuickActions() {
    final actions = [
      _QuickAction(
        ...
        Icons.add_circle,
        AppTheme.neonCyan,
        () => context.push(RouteConstants.marketingHQPath),
      ),
      _QuickAction(
        'Post Now',
        Icons.send,
        AppTheme.neonMagenta,
        () => context.push(RouteConstants.socialQueuePath),
      ),
      _QuickAction(
        'Generate QR',
        Icons.qr_code_2,
        AppTheme.neonGreen,
        () => context.push(RouteConstants.qrPromoPath),
      ),
      _QuickAction(
        'Link-in-Bio',
        Icons.link,
        AppTheme.neonOrange,
        () => context.push(RouteConstants.linkInBioPath),
      ),
      _QuickAction(
        'View Pipeline',
        Icons.water,
        AppTheme.neonPurple,
        () => context.push(RouteConstants.contentPipelineDashboardPath),
      ),
      _QuickAction(
        'Engagement',
        Icons.trending_up,
        const Color(0xFFFFD700),
        () => context.push(RouteConstants.engagementDashboardPath),
      ),
      _QuickAction(
        'Poster Maker',
        Icons.brush,
        const Color(0xFFFF6B6B),
        () => context.push(RouteConstants.posterGeneratorPath),
      ),
      _QuickAction(
        'Warehouse',
        Icons.factory,
        const Color(0xFF00E5FF),
        () => context.push(RouteConstants.promotionWarehousePath),
      ),
    ];
