...
class _TikeRocketScreenState extends State<TikeRocketScreen>
  ...
  void initState() {
    ...
    _coinPulse = AnimationController(vsync: this, duration: const Duration(seconds: 2))
      ..repeat(reverse: true);
    _coinAnim = Tween<double>(begin: 0.85, end: 1.0)
    ...
    child: Row(
      children: [
        ...
        const Column(
          ...
          children: [
            Text('TIKEROCKET', style: TextStyle(
              color: Colors.white, fontSize: 15, fontWeight: FontWeight.w900, letterSpacing: 2,
            )),
            Text('DFC Digital Ticketing', style: TextStyle(color: Colors.white38, fontSize: 10)),
          ],
        ),
        const Spacer(),
        _fcBadge('LIVE'),
  ...
  Widget _fcBadge(String label) => Container(
    ...
    child: Text(label, style: const TextStyle(
      color: _green, fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1,
    )),
  );
  ...
  Widget _buildWalletCard() => AnimatedBuilder(
    ...
    builder: (_, __) => Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _gold.withValues(alpha: 0.3 * _coinAnim.value)),
        boxShadow: [
          BoxShadow(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: _gold.withValues(alpha: 0.4), blurRadius: 12)],
                ),
                child: const Center(
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('DFC FIGHT COINS', style: TextStyle(
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                        color: _gold, fontSize: 28, fontWeight: FontWeight.w900,
                      ),
                    ),
                    Text(
              ...
              Column(
                children: [
                  _walletAction('BUY FC', _cyan, Icons.add_circle_outline, () {}),
                  const SizedBox(height: 8),
                  _walletAction('HISTORY', Colors.white38, Icons.receipt_long, () => _showHistory(snap.data)),
                ],
              ),
            ],
          );
  ...
  Widget _walletAction(String label, Color color, IconData icon, VoidCallback onTap) =>
      GestureDetector(
        onTap: onTap,
        child: Container(
  ...
  Widget _buildTabBar() => Container(
    ...
    child: TabBar(
      ...
      tabs: const [
        Tab(icon: Icon(Icons.confirmation_number, size: 16), text: 'MY TICKETS'),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(ticket.eventTitle, style: const TextStyle(
            ...
            child: Row(
              children: [
                ...
                Text(statusLabel, style: TextStyle(
                  color: statusColor, fontSize: 11, fontWeight: FontWeight.w800, letterSpacing: 1,
                )),
                const Spacer(),
                if (ticket.seat != null)
                  Text('SEAT ${ticket.seat}', style: const TextStyle(
              ...
              children: [
                ...
                if (ticket.status == TicketStatus.active)
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Icon(Icons.qr_code_2, color: Colors.white24, size: 48),
                    ),
                  ),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _ticketInfoRow('Paid', '\$${ticket.pricePaid.toStringAsFixed(2)} AUD'),
                      if (ticket.fightCoinsSpent > 0)
                        _ticketInfoRow('FC used', '${ticket.fightCoinsSpent.toStringAsFixed(0)} ⚡'),
                      const SizedBox(height: 12),
                      if (ticket.status == TicketStatus.active) ...[
                        Row(
                          children: [
                            Expanded(child: _actionBtn('TRANSFER', _cyan, Icons.send, () => _showTransferSheet(ticket))),
                            const SizedBox(width: 8),
                            Expanded(child: _actionBtn('RESALE', _gold, Icons.storefront, () => _showResaleSheet(ticket))),
                          ],
                        ),
                      ],
                      if (ticket.status == TicketStatus.active)
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: _actionBtn('TAP QR TO ENTER', _green, Icons.qr_code_scanner, () => _showQrFullscreen(ticket)),
                          ),
                        ),
                    ],
                  ),
  ...
  Widget _buildBuyTickets() {
    ...
    const events = [
      _EventListing(
        ...
        flag: '🇦🇺',
        tiers: [
          _TicketTier('General Admission', 49, TicketType.general, Colors.white70),
      ...
      _EventListing(
        ...
        flag: '🇦🇺',
        tiers: [
          _TicketTier('General Admission',  35, TicketType.general, Colors.white70),
      ...
      _EventListing(
        ...
        flag: '🇸🇬',
        tiers: [
          _TicketTier('General Admission',  75, TicketType.general, Colors.white70),
    ...
    child: Column(
      ...
      children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(e.subtitle, style: TextStyle(
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(e.sport, style: const TextStyle(
                      color: _red, fontSize: 9, fontWeight: FontWeight.w900,
                    )),
                  ),
                  const SizedBox(height: 4),
                  Text(e.promotion, style: const TextStyle(
                    color: Colors.white38, fontSize: 10,
                  )),
                ],
              ),
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 4),
                  Text(e.venue, style: const TextStyle(color: Colors.white54, fontSize: 11)),
                ],
              ),
              const SizedBox(height: 4),
              Row(
        ...
        Padding(
          ...
          child: Column(
            children: e.tiers.map((tier) => Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        tier.type == TicketType.ppv ? Icons.live_tv :
                        tier.type == TicketType.vip ? Icons.star : Icons.confirmation_number,
                        color: tier.color, size: 18,
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                        child: Text(tier.name, style: TextStyle(
                          color: tier.color, fontSize: 13, fontWeight: FontWeight.w800,
                        )),
                      ),
                      Text('\$${tier.priceAud} AUD', style: const TextStyle(
                        color: Colors.white, fontSize: 14, fontWeight: FontWeight.w900,
                      )),
                      const SizedBox(width: 10),
                      Container(
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(t.eventTitle, style: const TextStyle(
                color: Colors.white, fontSize: 13, fontWeight: FontWeight.w800,
              )),
              Text('${t.type.name.toUpperCase()} · ${_formatDate(t.eventDate)}',
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Text('\$${t.resalePrice?.toStringAsFixed(2) ?? '--'} AUD',
              style: const TextStyle(
      ...
      builder: (_) => Dialog(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text(ticket.eventTitle, textAlign: TextAlign.center,
                style: const TextStyle(
                  color: Colors.black, fontSize: 16, fontWeight: FontWeight.w900,
                )),
              const SizedBox(height: 4),
              Text(_formatDate(ticket.eventDate), textAlign: TextAlign.center,
              ...
              const Text('SHOW TO GATE STAFF TO ENTER',
                style: TextStyle(color: Colors.black38, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1)),
              const SizedBox(height: 8),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                decoration: BoxDecoration(
                ...
                child: Text(ticket.type.name.toUpperCase(),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('TRANSFER TICKET', style: TextStyle(
              color: _cyan, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 2,
            )),
            const SizedBox(height: 4),
            Text(ticket.eventTitle, style: const TextStyle(color: Colors.white54, fontSize: 12)),
            const SizedBox(height: 20),
            TextField(
              controller: ctrl,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text(success ? '✅ Ticket transferred!' : '❌ Transfer failed'),
                ...
                child: const Text('CONFIRM TRANSFER', style: TextStyle(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSt) => Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('LIST FOR RESALE', style: TextStyle(
                color: _gold, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 2,
              )),
              const SizedBox(height: 4),
              Text(ticket.eventTitle, style: const TextStyle(color: Colors.white54, fontSize: 12)),
              const SizedBox(height: 20),
              Text('Resale price: \$${price.toStringAsFixed(2)} AUD',
              ...
              const SizedBox(height: 8),
              const Text('DFC takes 10% platform fee. You receive the rest.',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(success ? '✅ Listed for resale at \$${price.toStringAsFixed(2)}!' : '❌ Failed to list'),
                        backgroundColor: success ? _green : _red,
                      ));
                    }
                  },
                  ...
                  child: const Text('LIST ON RESALE MARKET', style: TextStyle(
                    fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 1,
                  )),
                ),
              ),
        ...
        child: Column(
          ...
          children: [
            Text('BUY TICKET', style: TextStyle(
              color: tier.color, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 2,
            )),
            const SizedBox(height: 4),
            Text(event.title, style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w800)),
  ...
  Widget _purchaseRow(String label, String value, {bool bold = false}) => Padding(
    padding: const EdgeInsets.only(bottom: 8),
    child: Row(
      children: [
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSt) => Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('SEND FIGHT COINS ⚡', style: TextStyle(
                color: _gold, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 2,
              )),
              const SizedBox(height: 20),
              TextField(
              ...
              const SizedBox(height: 16),
              Text('Amount: ${amount.toStringAsFixed(0)} ⚡ FC',
                style: const TextStyle(color: _gold, fontSize: 18, fontWeight: FontWeight.w900)),
              Slider(
                value: amount, min: 1, max: 500,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    Navigator.pop(ctx);
                    final success = await TikeRocketService().transferFightCoins(
                      fromUserId: widget.userId,
                      toUserId: ctrl.text.trim(),
                      amount: amount,
                  ...
                  child: const Text('SEND FIGHT COINS', style: TextStyle(
                    fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 1,
                  )),
                ),
              ),
                ...
                child: Row(
                  children: [
                    Container(
                      width: 32, height: 32,
                      decoration: BoxDecoration(
                        color: tx.amount > 0 ? _green.withValues(alpha: 0.1) : _red.withValues(alpha: 0.1),
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
                        tx.type == 'transfer' ? Icons.send :
                        tx.type == 'purchase' ? Icons.local_activity : Icons.receipt_long,
                        size: 14,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(_formatDate(tx.createdAt), style: const TextStyle(color: Colors.white38, fontSize: 10)),
                        ],
                      ),
                    ),
                    Text('${tx.amount > 0 ? '+' : ''}${tx.amount.toStringAsFixed(0)} ⚡',
                      style: TextStyle(
                        color: tx.amount >= 0 ? _green : _red,
  ...
  void _confirmBuyResale(DfcTicket ticket) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Buy Resale Ticket', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900)),
        content: Text(
          '${ticket.eventTitle}\n${ticket.type.name.toUpperCase()}\n\n'
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text(success ? '✅ Ticket purchased!' : '❌ Purchase failed'),
                  backgroundColor: success ? _green : _red,
                ));
              }
            },
  ...
  Widget _emptyState(String emoji, String title, String sub, Color color) => Center(
    child: Column(
      mainAxisSize: MainAxisSize.min,
      children: [
